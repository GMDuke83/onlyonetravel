# Historical README — not current operating instructions

Retained for design and asset history. For current backend, security and deployment use the root README and deployment-checklist.md.
...
│   │   ├── onlyone-hero-terrace-v2.mp4 intro hero (silent)
