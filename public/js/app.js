...
"m":"м","PRIVATE CHARTER":"ПРИВАТНИЙ ЧАРТЕР","Our yachts":"Наші яхти","Weekly charters from the international fleet and day runs along the Turkish coast. Rates are from-guides excl. APA and taxes; your VIP assistant prepares the exact offer.":"Тижневий чартер зі світового флоту та денні виходи вздовж турецького узбережжя. Ціни орієнтовні («від», без APA та податків); точну пропозицію підготує ваш VIP-асистент.","All":"Усі","under 35 m":"до 35 м","Weekly charter":"Тижневий чартер","Day charters · Türkiye":"Денні тури · Туреччина","day rates from":"ціна за день від","weekly rates from":"ціна за тиждень від","per route from":"за маршрут від","per flight from":"за переліт від","Photo coming soon":"Фото незабаром","For this filter we will match you personally — the fleet is larger than this page.":"Під цей фільтр підберемо варіант особисто — флот ширший за цю сторінку.","A larger yacht, a gulet for a week or a flotilla for an event? We source beyond this page.":"Потрібна більша яхта, гулет на тиждень чи флотилія для події? Знайдемо й поза цією сторінкою.","A flybridge built for the golden hour: a wide aft deck, a chef on board and the sunset over the bay on the way home.":"Флайбридж для золотої години: простора кормова палуба, шеф на борту й захід сонця над бухтою дорогою назад.","A day in Kemer’s turquoise coves: anchor in still water, swim straight off the bathing platform, lunch under the awning.":"День у бірюзових бухтах Кемера: якір у тихій воді, купання просто з платформи та обід під тентом.","The twelve islands of Göcek from the water: lagoons, pine-lined shores and a route the captain shapes around your day.":"Дванадцять островів Гьоджека з води: лагуни, соснові береги та маршрут, який капітан вибудовує під ваш день.","The evening cruise with dinner on board: decks in warm light, the table laid, the Bodrum shore fading slowly astern.":"Вечірній вихід із вечерею на борту: палуби в теплому світлі, накритий стіл і берег Бодрума, що повільно гасне за кормою.","Fethiye":"Фетхіє","Göcek":"Гьоджек","VIP TRANSFER":"VIP-ТРАНСФЕР","VIP transport":"VIP-транспорт","Limousine, VIP bus or helicopter — with chauffeur or pilot, welcome and escort. Rates are a guide for the Antalya region.":"Лімузин, VIP-бус чи гелікоптер — з водієм або пілотом, зустріччю та супроводом. Ціни орієнтовні, для регіону Антальї.","Limousine":"Лімузин","VIP bus":"VIP-бус","Helicopter":"Гелікоптер","Chauffeured limousine":"Лімузин з водієм","Chauffeured VIP bus":"VIP-бус з водієм","Helicopter transfer":"Трансфер гелікоптером","up to 3 guests · 3 cases":"до 3 гостей · 3 валізи","up to 10 guests · 12 cases":"до 10 гостей · 12 валіз","up to 5 guests · light luggage":"до 5 гостей · легкий багаж","First class on the road: a name sign at arrivals, a cooled cabin, water and quiet — from the aircraft to the hotel door.":"Перший клас на дорозі: зустріч із табличкою, прохолодний салон, вода й тиша — від трапа до дверей готелю.","For a family or a team: a lounge cabin with individual seats, room for all the luggage and one vehicle for everyone.":"Для родини чи команди: салон-лаунж з окремими кріслами, місце для всього багажу та одне авто на всіх.","The coast in minutes instead of hours: departure from the airport or hotel, landing by the sea — the whole Lycian shore beneath you.":"Узбережжя за хвилини замість годин: виліт з аеропорту чи готелю, посадка біля моря — і весь Лікійський берег під вами.","Private helicopter":"Приватний гелікоптер","A convoy, an escort, meeting a private jet or a car for the whole day — arranged on request.":"Кортеж, ескорт, зустріч приватного джета чи авто на весь день — організуємо за запитом.","View our yachts":"Переглянути наші яхти","View vehicles & rates":"Транспорт і ціни","Vehicles & rates":"Транспорт і ціни","VIP transport & rates":"VIP-транспорт і ціни","Details":"Деталі","Length":"Довжина","Builder":"Верф","Cabins":"Каюти","Crew":"Екіпаж","Cruising area":"Маршрути","up to ":"до ","The rate is a guide per day with crew and fuel on the standard route. Your VIP assistant prepares the exact offer for your date.":"Ціна — орієнтир за день з екіпажем і пальним за стандартним маршрутом. Точну пропозицію на вашу дату підготує VIP-асистент.","From-rate per week, excl. APA and taxes. Your VIP assistant confirms availability for your dates and the exact offer.":"Ціна «від» за тиждень, без APA та податків. Наявність на ваші дати й точну пропозицію підтвердить VIP-асистент.","Enquire":"Запит","Book & pay":"Забронювати й оплатити","Thank you. Your VIP assistant will contact you about the yacht.":"Дякуємо. VIP-асистент зв’яжеться з вами щодо яхти.","Payment":"Оплата","Payment method":"Спосіб оплати","Card details are entered on the bank’s secured page (3-D Secure). We never see or store the card number.":"Дані картки вводяться на захищеній сторінці банку (3-D Secure). Ми не бачимо й не зберігаємо номер картки.","Continue to the bank":"Перейти до банку","The payment could not be started. Please try again.":"Не вдалося розпочати оплату. Спробуйте ще раз.","This bank is not activated yet.":"Оплату через цей банк ще не підключено.","Bank":"Банк","Simulate a decline":"Симулювати відмову","Simulate a successful payment":"Симулювати успішну оплату","Payment failed (demo).":"Оплату не виконано (демо).","The payment did not go through. Please try again or write to your VIP assistant.":"Оплата не пройшла. Спробуйте ще раз або напишіть VIP-асистенту.","Booking":"Бронювання","You are booking":"Що бронюємо","Start · 1 week":"Початок · 1 тиждень","Route":"Маршрут","Airport → hotel":"Аеропорт → готель","You pay the from-rate now. Final details and any extras are confirmed personally by your VIP assistant before the start.":"Зараз оплачується ціна «від». Фінальні деталі та можливі доплати VIP-асистент підтвердить з вами до початку.","Please fill in date, name and phone":"Заповніть дату, ім’я та телефон","Please choose a future date":"Оберіть дату в майбутньому","Your VIP assistant confirms the details of the day with you personally.":"Деталі дня ваш VIP-асистент узгодить з вами особисто.","Charter":"Чартер","Item":"Об’єкт","Payment open — the guest pays in the app":"Оплата відкрита — гість платить у застосунку","Booking confirmed":"Бронювання підтверджено","Accept & pay now":"Прийняти й оплатити зараз","Payment happens on our payment partner’s secured page (3-D Secure). We never see or store card details.":"Оплата відбувається на захищеній сторінці нашого платіжного партнера (3-D Secure). Ми не бачимо й не зберігаємо дані картки.","Once the payment arrives, your VIP assistant confirms the booking here in the app.":"Щойно оплата надійде, ваш VIP-асистент підтвердить бронювання тут, у застосунку.","Open the secure payment page":"Відкрити сторінку оплати","Payment received":"Оплата надійшла","Payment page link":"Посилання на сторінку оплати","Create the payment for this booking in the HotelRunner panel and paste the payment page link here. The guest opens it right in the app and pays with 3-D Secure.":"Створіть оплату для цього бронювання в панелі HotelRunner і вставте сюди посилання на сторінку оплати. Гість відкриє його просто в застосунку й оплатить із 3-D Secure.","Save link":"Зберегти посилання","Please paste a valid link (https://…)":"Будь ласка, вставте коректне посилання (https://…)","Marked as paid":"Позначено як оплачено","Request a payment":"Запросити оплату","Label":"Назва","Amount (EUR)":"Сума (EUR)","e.g. deposit for a yacht charter":"напр., депозит за чартер яхти","Payment request created":"Запит на оплату створено","Open the HotelRunner panel":"Відкрити панель HotelRunner"}}
  ...
  const yachtRateLabel=y=>y.week
    ?hx('цена за неделю от','Preis pro Woche ab','weekly rates from')
    :hx('цена за день от','Preis pro Tag ab','day rates from');
  const yachtCap=y=>{
  ...
  function vYachts(){
    ...
    return `${fleetHead({
      ...
      note:hx('Недельный чартер по мировому флоту и дневные выходы вдоль турецкого побережья. Цены ориентировочные («от», без APA и налогов); точное предложение соберёт ваш VIP-ассистент.',
              'Wochencharter aus der internationalen Flotte und Tagestörns entlang der türkischen Küste. Die Preise sind Ab-Richtwerte ohne APA und Steuern; das genaue Angebot erstellt Ihr VIP-Assistent.',
  ...
  function staffActions(r){
    ...
    if(r.status==='payopen'){
      /* Two ways into payopen: the staff link, and the guest's own
         ...
         through the payment provider's page (today: HotelRunner), which
  ...
  function sheetYacht(id){
    ...
    <div class="sheet__body">
      ...
      <div class="noteBox">${y.week
        ?hx('Цена «от» за неделю, без APA и налогов. Наличие на ваши даты и точное предложение подтвердит VIP-ассистент.',
            'Ab-Preis pro Woche, ohne APA und Steuern. Verfügbarkeit für Ihre Daten und das genaue Angebot bestätigt Ihr VIP-Assistent.',
            'From-rate per week, excl. APA and taxes. Your VIP assistant confirms availability for your dates and the exact offer.')
        :hx('Цена — ориентир за день с экипажем и топливом по стандартному маршруту. Точное предложение под вашу дату соберёт VIP-ассистент.',
            'Der Preis ist ein Richtwert pro Tag mit Crew und Kraftstoff auf der Standardroute. Das genaue Angebot für Ihr Datum erstellt Ihr VIP-Assistent.',
  ...
  function sheetPay(id){
    ...
    /* A real payment link on the request outranks the bank chooser: the
       ...
       HotelRunner), so it is the path where real money already flows.
  ...
  /* The link the assistant pastes here comes from the payment provider's
     panel — today that is HotelRunner: create the payment on the order,
     copy the payment page URL. The app never fabricates a link; only a
     real page may face a paying guest. */
  function sheetPayLink(id){
    ...
    <div class="sheet__body">
      ...
      <div class="field"><label class="label">${hx('Ссылка на страницу оплаты','Link zur Zahlungsseite','Payment page link')} *</label>
        <input class="input" id="plUrl" type="url" inputmode="url" placeholder="https://…hotelrunner.com/orders/…" value="${esc((r.payment&&r.payment.link)||'')}"></div>
      <a class="btn btn--ghost btn--sm" href="https://app.hotelrunner.com/" target="_blank" rel="noopener">${hx('Открыть панель HotelRunner','HotelRunner-Panel öffnen','Open the HotelRunner panel')}</a>
      <div class="noteBox">${hx('Создайте оплату к этой брони в панели HotelRunner и вставьте сюда ссылку на страницу оплаты. Гость откроет её прямо в приложении и оплатит с 3-D Secure.',
        'Im HotelRunner-Panel die Zahlung zu dieser Buchung anlegen und den Link der Zahlungsseite hier einfügen. Der Gast öffnet ihn direkt in der App und zahlt mit 3-D Secure.',
        'Create the payment for this booking in the HotelRunner panel and paste the payment page link here. The guest opens it right in the app and pays with 3-D Secure.')}</div>
    </div>
  ...
  /* The quick way for the assistant: an ad-hoc payment request — label,
     amount, HotelRunner link — that lands in the guest area as an open
  ...
  function sheetPayRequest(){
    ...
    <div class="sheet__body">
      ...
      <div class="field"><label class="label">${hx('Ссылка на страницу оплаты','Link zur Zahlungsseite','Payment page link')}</label>
        <input class="input" id="prLink" type="url" inputmode="url" placeholder="https://…hotelrunner.com/orders/…"></div>
      <a class="btn btn--ghost btn--sm" href="https://app.hotelrunner.com/" target="_blank" rel="noopener">${hx('Открыть панель HotelRunner','HotelRunner-Panel öffnen','Open the HotelRunner panel')}</a>
      <div class="noteBox">${hx('Создайте оплату к этой брони в панели HotelRunner и вставьте сюда ссылку на страницу оплаты. Гость откроет её прямо в приложении и оплатит с 3-D Secure.',
        'Im HotelRunner-Panel die Zahlung zu dieser Buchung anlegen und den Link der Zahlungsseite hier einfügen. Der Gast öffnet ihn direkt in der App und zahlt mit 3-D Secure.',
        'Create the payment for this booking in the HotelRunner panel and paste the payment page link here. The guest opens it right in the app and pays with 3-D Secure.')}</div>
    ...
    switch(act){
      ...
      case 'mark-paid': {
        /* The provider's page cannot call this app back; the assistant
           checks the panel (HotelRunner) and closes the loop here. */
        const r=request(id);if(!r)break;
        r.payment=r.payment||{};
        r.payment.status='paid';r.payment.paidAt=Date.now();
      ...
      case 'pay-open-link': {
        ...
        /* HotelRunner's checkout honours a locale parameter — hand the
