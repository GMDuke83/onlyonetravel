...
"m":"м","PRIVATE CHARTER":"ПРИВАТНИЙ ЧАРТЕР","Our yachts":"Наші яхти","Weekly charters from the international fleet and day runs along the Turkish coast. Rates are from-guides excl. APA and taxes; your VIP assistant prepares the exact offer.":"Тижневий чартер зі світового флоту та денні виходи вздовж турецького узбережжя. Ціни орієнтовні («від», без APA та податків); точну пропозицію підготує ваш VIP-асистент.","All":"Усі","under 35 m":"до 35 м","Weekly charter":"Тижневий чартер","Day charters · Türkiye":"Денні тури · Туреччина","day rates from":"ціна за день від","weekly rates from":"ціна за тиждень від","per route from":"за маршрут від","per flight from":"за переліт від","Photo coming soon":"Фото незабаром","For this filter we will match you personally — the fleet is larger than this page.":"Під цей фільтр підберемо варіант особисто — флот ширший за цю сторінку.","A larger yacht, a gulet for a week or a flotilla for an event? We source beyond this page.":"Потрібна більша яхта, гулет на тиждень чи флотилія для події? Знайдемо й поза цією сторінкою.","A flybridge built for the golden hour: a wide aft deck, a chef on board and the sunset over the bay on the way home.":"Флайбридж для золотої години: простора кормова палуба, шеф на борту й захід сонця над бухтою дорогою назад.","A day in Kemer’s turquoise coves: anchor in still water, swim straight off the bathing platform, lunch under the awning.":"День у бірюзових бухтах Кемера: якір у тихій воді, купання просто з платформи та обід під тентом.","The twelve islands of Göcek from the water: lagoons, pine-lined shores and a route the captain shapes around your day.":"Дванадцять островів Гьоджека з води: лагуни, соснові береги та маршрут, який капітан вибудовує під ваш день.","The evening cruise with dinner on board: decks in warm light, the table laid, the Bodrum shore fading slowly astern.":"Вечірній вихід із вечерею на борту: палуби в теплому світлі, накритий стіл і берег Бодрума, що повільно гасне за кормою.","Fethiye":"Фетхіє","Göcek":"Гьоджек","VIP TRANSFER":"VIP-ТРАНСФЕР","VIP transport":"VIP-транспорт","Limousine, VIP bus or helicopter — with chauffeur or pilot, welcome and escort. Rates are a guide for the Antalya region.":"Лімузин, VIP-бус чи гелікоптер — з водієм або пілотом, зустріччю та супроводом. Ціни орієнтовні, для регіону Антальї.","Limousine":"Лімузин","VIP bus":"VIP-бус","Helicopter":"Гелікоптер","Chauffeured limousine":"Лімузин з водієм","Chauffeured VIP bus":"VIP-бус з водієм","Helicopter transfer":"Трансфер гелікоптером","up to 3 guests · 3 cases":"до 3 гостей · 3 валізи","up to 10 guests · 12 cases":"до 10 гостей · 12 валіз","up to 5 guests · light luggage":"до 5 гостей · легкий багаж","First class on the road: a name sign at arrivals, a cooled cabin, water and quiet — from the aircraft to the hotel door.":"Перший клас на дорозі: зустріч із табличкою, прохолодний салон, вода й тиша — від трапа до дверей готелю.","For a family or a team: a lounge cabin with individual seats, room for all the luggage and one vehicle for everyone.":"Для родини чи команди: салон-лаунж з окремими кріслами, місце для всього багажу та одне авто на всіх.","The coast in minutes instead of hours: departure from the airport or hotel, landing by the sea — the whole Lycian shore beneath you.":"Узбережжя за хвилини замість годин: виліт з аеропорту чи готелю, посадка біля моря — і весь Лікійський берег під вами.","Private helicopter":"Приватний гелікоптер","A convoy, an escort, meeting a private jet or a car for the whole day — arranged on request.":"Кортеж, ескорт, зустріч приватного джета чи авто на весь день — організуємо за запитом.","View our yachts":"Переглянути наші яхти","View vehicles & rates":"Транспорт і ціни","Vehicles & rates":"Транспорт і ціни","VIP transport & rates":"VIP-транспорт і ціни","Details":"Деталі","Length":"Довжина","Builder":"Верф","Cabins":"Каюти","Crew":"Екіпаж","Cruising area":"Маршрути","up to ":"до ","The rate is a guide per day with crew and fuel on the standard route. Your VIP assistant prepares the exact offer for your date.":"Ціна — орієнтир за день з екіпажем і пальним за стандартним маршрутом. Точну пропозицію на вашу дату підготує VIP-асистент.","From-rate per week, excl. APA and taxes. Your VIP assistant confirms availability for your dates and the exact offer.":"Ціна «від» за тиждень, без APA та податків. Наявність на ваші дати й точну пропозицію підтвердить VIP-асистент.","Enquire":"Запит","Book & pay":"Забронювати й оплатити","Thank you. Your VIP assistant will contact you about the yacht.":"Дякуємо. VIP-асистент зв’яжеться з вами щодо яхти.","Payment":"Оплата","Payment method":"Спосіб оплати","Card details are entered on the bank’s secured page (3-D Secure). We never see or store the card number.":"Дані картки вводяться на захищеній сторінці банку (3-D Secure). Ми не бачимо й не зберігаємо номер картки.","Continue to the bank":"Перейти до банку","The payment could not be started. Please try again.":"Не вдалося розпочати оплату. Спробуйте ще раз.","This bank is not activated yet.":"Оплату через цей банк ще не підключено.","Bank":"Банк","Simulate a decline":"Симулювати відмову","Simulate a successful payment":"Симулювати успішну оплату","Payment failed (demo).":"Оплату не виконано (демо).","The payment did not go through. Please try again or write to your VIP assistant.":"Оплата не пройшла. Спробуйте ще раз або напишіть VIP-асистенту.","Booking":"Бронювання","You are booking":"Що бронюємо","Start · 1 week":"Початок · 1 тиждень","Route":"Маршрут","Airport → hotel":"Аеропорт → готель","You pay the from-rate now. Final details and any extras are confirmed personally by your VIP assistant before the start.":"Зараз оплачується ціна «від». Фінальні деталі та можливі доплати VIP-асистент підтвердить з вами до початку.","Please fill in date, name and phone":"Заповніть дату, ім’я та телефон","Please choose a future date":"Оберіть дату в майбутньому","Your VIP assistant confirms the details of the day with you personally.":"Деталі дня ваш VIP-асистент узгодить з вами особисто.","Charter":"Чартер","Item":"Об’єкт","Payment open — the guest pays in the app":"Оплата відкрита — гість платить у застосунку","Booking confirmed":"Бронювання підтверджено","Accept & pay now":"Прийняти й оплатити зараз","Payment happens on our payment partner’s secured page (3-D Secure). We never see or store card details.":"Оплата відбувається на захищеній сторінці нашого платіжного партнера (3-D Secure). Ми не бачимо й не зберігаємо дані картки.","Once the payment arrives, your VIP assistant confirms the booking here in the app.":"Щойно оплата надійде, ваш VIP-асистент підтвердить бронювання тут, у застосунку.","Open the secure payment page":"Відкрити сторінку оплати","Payment received":"Оплата надійшла","Payment page link":"Посилання на сторінку оплати","Create the payment in your payment provider’s panel and paste the payment page link here. The guest opens it right in the app and pays securely.":"Створіть оплату в панелі вашого платіжного сервісу та вставте сюди посилання на сторінку оплати. Гість відкриє його просто в застосунку й оплатить безпечно.","Save link":"Зберегти посилання","Please paste a valid link (https://…)":"Будь ласка, вставте коректне посилання (https://…)","Marked as paid":"Позначено як оплачено","Request a payment":"Запросити оплату","Label":"Назва","Amount (EUR)":"Сума (EUR)","e.g. deposit for a yacht charter":"напр., депозит за чартер яхти","Payment request created":"Запит на оплату створено"}}
  ...
  /* --- Charter fleet. The yacht and transport pages borrow the grammar of a
     ...
     and availability on request. Yacht prices are supplied only in a personal
     offer after availability has been checked. Vessel names are our own; builder and
  ...
  const YACHTS=[
    {id:'alara', img:'./images/r21/yacht-card-1.webp', name:'ALARA',
     m:24, builder:'Princess', year:2021, cabins:4, guests:10, crew:3,
     dests:['antalya','kemer'],
    ...
    {id:'mavi-ruya', img:'./images/r21/yacht-card-2.webp', name:'MAVI RUYA',
     m:21, builder:'Azimut', year:2019, cabins:3, guests:8, crew:2,
     dests:['kemer','antalya'],
    ...
    {id:'elara', img:'./images/r21/yacht-card-3.webp', name:'ELARA',
     m:27, builder:'Ferretti', year:2022, cabins:4, guests:12, crew:4,
     dests:['gocek','fethiye'],
    ...
    {id:'lady-lykia', img:'./images/r21/yacht-card-4.webp', name:'LADY LYKIA',
     m:26, builder:'Sunseeker', year:2020, cabins:5, guests:12, crew:4,
     dests:['bodrum','gocek'],
  ...
  /* --- Weekly charter fleet. Real vessels of the international charter
     ...
     31.08.2026): name, builder, year, length, staterooms, guests, crew are public market facts. Photographs are
     ...
     docs/chatgpt-bildauftrag.md). Availability and prices are checked individually on request. --- */
  const FLEET_SIZES=[
  ...
  const FLEET_WEEK=[
    {id:'lady-s',       name:'LADY S',        m:93,   ft:305, builder:'Feadship',      year:'2019',      cabins:7, guests:12, crew:31, size:'xl'},
    {id:'carinthia-vii',name:'CARINTHIA VII', m:97.2, ft:318, builder:'Lürssen',       year:'2002/2023', cabins:8, guests:12, crew:33, size:'xl'},
    {id:'starfire',     name:'STARFIRE',      m:73,   ft:240, builder:'Lürssen',       year:'2007',      cabins:7, guests:12, crew:20,  size:'xl'},
    {id:'twizzle',      name:'TWIZZLE',       m:57.5, ft:188, builder:'Royal Huisman', year:'2010',      cabins:4, guests:9,  crew:11,  size:'l'},
    {id:'prometheus-i', name:'PROMETHEUS I',  m:45,   ft:147, builder:'Heesen',        year:'1998',      cabins:5, guests:12, crew:10,  size:'l'},
    {id:'helios',       name:'HELIOS',        m:35.5, ft:116, builder:'Falcon',        year:'2010',      cabins:5, guests:12, crew:6,     size:'l'},
    {id:'iva',          name:'IVA',           m:29.2, ft:95,  builder:'Ferretti',      year:'2014',      cabins:5, guests:10, crew:5,     size:'m'},
    {id:'seaclusion',   name:'SEACLUSION',    m:24,   ft:78,  builder:'Sunreef',       year:'2020',      cabins:4, guests:8,  crew:4,     size:'m'},
    {id:'daiquiri',     name:'DAIQUIRI',      m:20.6, ft:67,  builder:'Lagoon',        year:'2022',      cabins:5, guests:10, crew:4,     size:'m'},
    {id:'yume',         name:'YUME',          m:21.9, ft:71,  builder:'YYachts',       year:'2024',      cabins:3, guests:6,  crew:2,     size:'m'},
  ...
  const VEHICLES=[
    ...
    {id:'helicopter', img:'./images/r18/transfer-heli.webp', cls:'heli',
     name:{ru:'Частный вертолёт',de:'Privater Helikopter',en:'Private helicopter'},  perFlight:true,
  ...
  const yachtCap=y=>{
    /* Built from numbers, so the EXTRA_TEXT table cannot carry it — the two
       extra languages get their own sentence here. Ukrainian shares the
       Slavic plural rule ruPl encodes. */
    if(LANG==='tr')return `${y.cabins} kabin · en fazla ${y.guests} misafir · ${y.crew} mürettebat`;
    if(LANG==='uk')return `${y.cabins} ${ruPl(y.cabins,'каюта','каюти','кают')} · до ${y.guests} гостей · екіпаж ${y.crew}`;
    return hx(
  ...
  const fleetCtaLabel=f=>f==='yachts'
    ...
    :hx('Транспорт и цены','Fahrzeuge & Preise ansehen','View vehicles & rates');
  function vBlock(id){
  ...
  function vHome(){
    ...
    <section class="homeVipServices">
      ...
      <div class="homeVipServices__links">
        <button type="button" data-go="transfers">${icon('car')}<span>${hx('VIP-транспорт и цены','VIP-Transport & Preise','VIP transport & rates')}</span>${icon('chev')}</button>
    ...
    <section class="homeTransferRequest homeTransferRequest--tile">
      <div class="homeTransferTile">
        <div class="homeTransferRequest__copy"><div class="eyebrow">${hx('ONLY ONE TRAVEL · VIP-ТРАНСФЕР','ONLY ONE TRAVEL · VIP-TRANSFER','ONLY ONE TRAVEL · VIP TRANSFER')}</div>
          ...
          <button type="button" class="homeTransferTile__fleet" data-go="transfers">${hx('Транспорт и цены','Fahrzeuge & Preise ansehen','Vehicles & rates')}${icon('chev')}</button>
        </div>
      </div>
    </section>
  ...
  async function submitRequest(){
    ...
    if(!await BACKEND.flush()){toast('Anfrage noch nicht gesendet. Bitte Verbindung prüfen.');return;}
    W=null;
    STACK.length=0;
    go('sent',id,true);
  }
  ...
  function vTripCharter(r){
    ...
    <div class="wrap" style="padding-top:16px">
      ...
      <div style="margin-top:18px"><span class="pill ${STATUS_PILL[r.status]}">${t(STATUS_LABEL[r.status])}</span></div>
      ${r.offer?`<div class="priceBox fade-up" style="margin-top:18px">
        <div class="lbl">${t('yourOffer')}</div>
        <div class="amt">${money(r.offer.price,r.offer.currency)}</div>
        ${r.offer.validUntil?`<div class="muted tiny">${t('validUntil')}: ${fmtDate(r.offer.validUntil)}</div>`:''}
  ...
  function vConcierge(){
    ...
    <div class="wrap concScreen" style="padding-top:24px">
      ...
      <div style="margin-top:26px;display:flex;flex-direction:column;gap:10px">
        <button class="btn btn--ghost" data-go="transfers">${icon('car')}${hx('VIP-транспорт и цены','VIP-Transport & Preise','VIP transport & rates')}</button>
  ...
  function staffActions(r){
    ...
    if(r.status==='payopen'){
      /* Two ways into payopen: the staff link, and the guest's own
         "pay now" (direct bookings, accept & pay). Real money arrives
         through the payment provider's hosted page, which
         cannot call us back — so the assistant closes the loop by hand:
         attach the link here, check the provider's panel, mark as paid. */
      const markBtn=`<button class="btn btn--ghost btn--sm" data-act="mark-paid" data-id="${r.id}">${hx('Оплата поступила','Zahlung eingegangen','Payment received')}</button>`;
      if(!(r.payment&&r.payment.link))
        return `<div class="listCard" style="margin-top:0">
          ...
          <div class="btnRow" style="margin-top:11px">
            <button class="btn btn--primary btn--sm" data-act="paylink" data-id="${r.id}">${icon('card')}${t('createPayLink')}</button>
            ${markBtn}</div></div>`;
      return `<div class="listCard" style="margin-top:0">
        ...
        <div class="btnRow" style="margin-top:11px">
          ...
          <button class="btn btn--ghost btn--sm" data-act="notify">${t('sendWa')}</button></div>
        <div class="btnRow" style="margin-top:8px">${markBtn}</div></div>`;
    }
    if(r.status==='paid')
  ...
  function render(restore){
    ...
    if(VIEW.name==='trip'){
      const r=request(VIEW.param);
      const payments=(r?.folio?.payments||[]).filter(p=>p.status==='pending');
      if(payments.length)html='<div class="wrap" style="padding-top:20px">'+payments.map(p=>'<div class="listCard"><b>'+esc(t('paymentRequestFor'))+'</b><p>'+esc(p.instructions||'')+'</p><p>'+esc(p.reference||'')+' · '+esc(p.due||'')+'</p><b>'+money(p.amount,p.currency)+'</b></div>').join('')+'</div>'+html;
    }
  ...
  function sheetMenu(){
    ...
    <div class="sheet__body">
      ...
      <div style="margin-top:18px"><a class="btn btn--dark" href="./operations.html">Travel Operations</a><button class="btn btn--dark" data-mgo="staff">${icon('lock')}${t('mStaff')}</button></div>
    </div>`);
  }
  ...
  function sheetYacht(id){
    ...
    <div class="sheet__body">
      ...
      <div class="noteBox">${t('yachtRequestNote')}</div>
      <div class="grid2">
        <div class="field"><label class="label" for="ycDate">${t('yachtStart')} *</label><input class="input" id="ycDate" type="date" min="${today()}" required></div>
        <div class="field"><label class="label" for="ycEnd">${t('yachtEnd')} *</label><input class="input" id="ycEnd" type="date" min="${today()}" required></div>
      </div>
      <div class="field"><label class="label" for="ycGuests">${t('guests')} *</label><input class="input" id="ycGuests" type="number" inputmode="numeric" min="1" max="${y.guests}" step="1" value="2" required></div>
      <div class="field"><label class="label" for="ycNote">${t('otherWishes')}</label><textarea class="input" id="ycNote" rows="2"></textarea></div>
      <div class="field"><label class="label" for="ycName">${hx('Имя','Name','Name')} *</label><input class="input" id="ycName" autocomplete="name" required></div>
      <div class="field"><label class="label" for="ycPhone">${hx('Телефон','Telefon','Phone')} *</label><input class="input" id="ycPhone" required type="tel" inputmode="tel" autocomplete="tel" placeholder="+90 ..."></div>
    </div>
    <div class="sheet__foot"><button class="btn btn--gold" data-act="yacht-send" data-id="${id}">${t('sendRequest')}</button></div>`);
  }
  /* --------------------------------------------------------------------
  ...
  function sheetPay(id){
    ...
    /* A real payment link on the request outranks the bank chooser: the
       ...
       The provider's page cannot redirect back into this app — the
       assistant confirms the arrival, which the note says honestly. */
    if(r.payment&&r.payment.link){
      ...
      <div class="sheet__body">
        ...
        <div class="listCard" style="display:flex;align-items:center;gap:11px">
          ...
          <span class="muted mini">${hx('Оплата проходит на защищённой странице нашего платёжного партнёра (3-D Secure). Мы не видим и не храним данные карты.',
            'Die Zahlung läuft auf der gesicherten Seite unseres Zahlungspartners (3-D Secure). Wir sehen und speichern keine Kartendaten.',
            'Payment happens on our payment partner’s secured page (3-D Secure). We never see or store card details.')}</span></div>
        <div class="noteBox">${hx('Как только оплата поступит, VIP-ассистент подтвердит бронирование здесь, в приложении.',
          'Sobald die Zahlung eingegangen ist, bestätigt Ihr VIP-Assistent die Buchung hier in der App.',
          'Once the payment arrives, your VIP assistant confirms the booking here in the app.')}</div>
      </div>
      <div class="sheet__foot"><button class="btn btn--primary" data-act="pay-open-link" data-id="${id}">${hx('Открыть страницу оплаты','Sichere Zahlungsseite öffnen','Open the secure payment page')}</button></div>`);
      return;
    }
    openSheet(`<div class="sheet__head"><h3 class="h-lg">${hx('Оплата','Zahlung','Payment')}</h3>
      <button class="iconBtn" data-sheet-close>${icon('close')}</button></div>
  ...
  /* --------------------------------------------------------------------
     Yacht enquiries start at 'new' without an offer or payment. Transfers
     retain direct booking at their listed rate. Both share the request,
     staff offer and payment model.
     -------------------------------------------------------------------- */
  ...
  function sheetBookCharter(bt,bid){
    ...
    const rateLabel=rateWordFleet(it.perFlight);
  ...
  function sheetPayLink(id){
    ...
    <div class="sheet__body">
      ...
      <div class="noteBox">${hx('Создайте оплату в панели вашего платёжного сервиса и вставьте сюда ссылку на страницу оплаты. Гость откроет её прямо в приложении и оплатит безопасно.',
        'Die Zahlung im Panel des Zahlungsanbieters anlegen und den Link der Zahlungsseite hier einfügen. Der Gast öffnet ihn direkt in der App und zahlt sicher.',
  ...
  /* The quick way for the assistant: an ad-hoc payment request — label,
     ...
     payment. Made for testing the loop on one phone, useful for real
     deposits and custom offers just the same. */
  function sheetPayRequest(){
    openSheet(`<div class="sheet__head"><h3 class="h-lg">${hx('Запросить оплату','Zahlung anfordern','Request a payment')}</h3>
      <button class="iconBtn" data-sheet-close>${icon('close')}</button></div>
    <div class="sheet__body">
      <div class="field" style="margin-top:0"><label class="label">${hx('Название','Bezeichnung','Label')} *</label>
        <input class="input" id="prLabel" placeholder="${hx('Например: депозит за чартер','z. B. Anzahlung Yachtcharter','e.g. deposit for a yacht charter')}"></div>
      <div class="field"><label class="label">${hx('Сумма (EUR)','Betrag (EUR)','Amount (EUR)')} *</label>
        <input class="input" id="prAmount" type="number" inputmode="decimal" min="1" placeholder="180"></div>
      <div class="field"><label class="label">${hx('Ссылка на страницу оплаты','Link zur Zahlungsseite','Payment page link')}</label>
        <input class="input" id="prLink" type="url" inputmode="url" placeholder="https://…"></div>
      <div class="noteBox">${hx('Создайте оплату в панели вашего платёжного сервиса и вставьте сюда ссылку на страницу оплаты. Гость откроет её прямо в приложении и оплатит безопасно.',
        'Die Zahlung im Panel des Zahlungsanbieters anlegen und den Link der Zahlungsseite hier einfügen. Der Gast öffnet ihn direkt in der App und zahlt sicher.',
        'Create the payment in your payment provider’s panel and paste the payment page link here. The guest opens it right in the app and pays securely.')}</div>
    </div>
    <div class="sheet__foot"><button class="btn btn--primary" data-act="payreq-save">${hx('Запросить оплату','Zahlung anfordern','Request a payment')}</button></div>`);
  }
  ...
  document.addEventListener('click',async e=>{
    ...
    switch(act){
      ...
      case 'yacht-send': {
        if(a.disabled)break;
        const y=yachtById(a.dataset.id);if(!y)break;
        const value=id=>(($(id)||{}).value||'').trim();
        const first=value('#ycName'),phone=value('#ycPhone');
        const date=value('#ycDate'),to=value('#ycEnd'),guests=Number(value('#ycGuests'));
        if(!first||!phone||!date||!to){toast(t('required'));break;}
        const validDate=d=>/^\d{4}-\d{2}-\d{2}$/.test(d)&&Number.isFinite(Date.parse(d))&&new Date(d).toISOString().slice(0,10)===d;
        if(!validDate(date)||!validDate(to)||date<today()||to<date){toast(t('yachtDatesInvalid'));break;}
        if(!Number.isInteger(guests)||guests<1||guests>y.guests){toast(t('yachtGuestsInvalid'));break;}
        a.disabled=true;
        const req=newCharterBooking({t:'yacht',id:y.id,name:y.name,img:y.img,
          date,to,guests,first,phone,note:value('#ycNote')});
        closeSheet();
        setTimeout(()=>{go('trip',req.id);toast(t('reqSent'));},330);
        break;
      }
      ...
      case 'exc-send': {
        ...
        if(!await BACKEND.flush()){a.disabled=false;toast('Anfrage noch nicht gesendet. Bitte Verbindung prüfen.');break;}
      ...
      case 'paylink': sheetPayLink(id);break;
      case 'paylink-save': {
        const r=request(id);if(!r)break;
        const u=(($('#plUrl')||{}).value||'').trim();
        if(!/^https:\/\/\S+\.\S+/i.test(u)){
          toast(hx('Вставьте корректную ссылку (https://…)','Bitte einen gültigen Link einfügen (https://…)','Please paste a valid link (https://…)'));break;
        }
        r.payment=Object.assign({},r.payment||{},{link:u,status:'open',createdAt:(r.payment&&r.payment.createdAt)||Date.now()});
        if(r.status!=='payopen')setStatus(r,'payopen');else save();
        closeSheet();setTimeout(()=>{render();toast(t('payLinkDone'));},280);break;
      }
      case 'payreq-form': sheetPayRequest();break;
      case 'payreq-save': {
        const label=(($('#prLabel')||{}).value||'').trim();
        const amount=parseFloat(((($('#prAmount')||{}).value)||'').replace(',','.'));
        const link=(($('#prLink')||{}).value||'').trim();
        if(!label||!amount||amount<=0){toast(t('required'));break;}
        if(link&&!/^https:\/\/\S+\.\S+/i.test(link)){
          toast(hx('Вставьте корректную ссылку (https://…)','Bitte einen gültigen Link einfügen (https://…)','Please paste a valid link (https://…)'));break;
        }
        const req=newCharterBooking({t:'service',id:'payreq',name:label,img:'',price:amount,
          date:today(),to:'',guests:1,route:'',note:'',first:S.staff||'Staff',phone:''});
        if(link){req.payment.link=link;save();}
        closeSheet();
        setTimeout(()=>{go('s-reqd',req.id);toast(hx('Запрос на оплату создан','Zahlungsanforderung erstellt','Payment request created'));},280);
        break;
      }
      case 'mark-paid': {
        /* The provider's page cannot call this app back; the assistant
      ...
      case 'pay-open-link': {
        const r=request(id);if(!(r&&r.payment&&r.payment.link))break;
        /* A hotelrunner.com checkout honours a locale parameter — hand the
           guest the page in the app's language when the link has none. */
        let u=r.payment.link;
        if(/hotelrunner\.com/.test(u)&&!/[?&]locale=/.test(u)){
          const lc={ru:'ru-RU',de:'de-DE',en:'en-US',tr:'tr-TR',uk:'uk-UA'}[LANG]||'en-US';
          u+=(u.includes('?')?'&':'?')+'locale='+lc;
        }
        /* A new tab keeps the app alive underneath; if the browser eats
           the popup, the same tab is better than nothing. */
