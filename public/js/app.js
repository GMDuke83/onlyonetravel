...
(function () {
  ...
  function siteFooter(){
    ...
    return `<footer class="siteFooter">
      ...
      <p class="siteFooter__line">${hx('Один человек ведёт всю вашу поездку — от первого вопроса до возвращения домой.','Eine Person begleitet deine ganze Reise – von der ersten Frage bis zurück nach Hause.','One person carries your whole journey — from the first question to the way home.')}</p>
      ...
      <div class="siteFooter__follow">
        <span class="siteFooter__followLabel">${hx('Мы в сетях','Folgen','Follow')}</span>
  ...
  function vHome(){
    ...
    const promos=[
      ...
      {img:'./images/r18/promo-private-beach.webp',tag:hx('ОТДЫХ','AUSZEIT','ESCAPE'),title:hx('Private Beach Escape','Private Beach Escape','Private Beach Escape'),meta:hx('Пляжный клуб · закат · релакс','Beach Club · Sunset · Relax','Beach club · sunset · relax'),attr:'data-go="concierge"'},
