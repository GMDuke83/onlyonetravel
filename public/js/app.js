  ...
  function vHome(){
    ...
    <section class="homeVipServices">
      <div class="homeEditorialHead homeEditorialHead--dark"><div class="eyebrow">ONLYONE · ${hx('VIP-СЕРВИСЫ','VIP-SERVICES','VIP SERVICES')}</div>
        <h2>${hx('VIP-приём, трансфер и яхта','VIP-Empfang, Transfer & Yacht','VIP welcome, transfer & yacht')}</h2>
        <p class="homeEditorialHead__sub">${hx('Личная встреча, Business Van, вертолёт и приватная яхта — всё организуется персонально.','Persönlicher Empfang, Business Van, Helikopter und private Yacht – individuell organisiert.','Personal welcome, business van, helicopter and private yacht — arranged individually.')}</p></div>
